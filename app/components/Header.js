...
//           <div className="w-64 bg-white dark:bg-true-black p-6">
//             <button
//               className="mb-4 flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300"
//               onClick={toggleSidebar}
//             >
//               <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
//               <a href="https://github.com/sidgupt12/forgetai" className="block text-gray-700 dark:text-gray-200">GitHub</a>
//               <a href="#sponsor" className="block text-gray-700 dark:text-gray-200">Sponsor</a>
//               <ThemeToggle />
//             </nav>
//           </div>
//         </div>
