...
export default function SignInPage() {
  return (
    <div className="flex flex-col md:flex-row h-screen">
      {/* Left side - Sign In Component */}
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-4 md:p-8 bg-white dark:bg-gray-900">
        <div className="w-full max-w-md">
          {/* Mobile "ForgetAI" text */}
          <h1 className="text-3xl font-extrabold tracking-tight mb-6 text-gray-900 dark:text-white md:hidden flex items-center justify-center">
            <span className="inline-flex">
