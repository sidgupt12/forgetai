  ...
  return (
    ...
    <div className="fixed inset-0 flex flex-col bg-gradient-to-b from-gray-50 via-white to-gray-100 dark:from-zinc-900 dark:via-zinc-950 dark:to-black">
      ...
      <div className="flex-1 flex flex-col overflow-hidden pt-16"> {/* Offset for Header */}
        {/* Chat Messages Area */}
        <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-zinc-700 scrollbar-track-transparent chat-messages-container">
        ...
        <div className="flex-shrink-0 p-4 md:p-6 bg-gradient-to-t from-gray-100 to-white dark:from-black dark:to-zinc-950 border-t border-gray-200 dark:border-zinc-700/50">
